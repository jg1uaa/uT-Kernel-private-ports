...
/*
 *	@(#)sysdef_depend.h (tk/lpc2388)
 *
 *	Definition about LPC2388
 *
...
#define VICSWPriorityMask	(VICBase + 0x0024)
#define VICVectAddr(x)		(VICBase + 0x0100 + ((x) * 4))
#define VICVectPriority(x)	(VICBase + 0x0200 + ((x) * 4))
#define VICAddress		(VICBase + 0x0f00)
...
#define CCLKCFG			(SystemControlBase + 0x0104)	// LPC23xx
#define USBCLKCFG		(SystemControlBase + 0x0108)	// LPC23xx
#define CLKSRCSEL		(SystemControlBase + 0x010c)	// LPC23xx
#define PCLKSEL0		(SystemControlBase + 0x01a8)	// LPC23xx
#define PCLKSEL1		(SystemControlBase + 0x01ac)	// LPC23xx
