...
/* ROMINFO */
#define SYSTEMAREA_TOP	0x20000000	/* RAM system area top */
#define SYSTEMAREA_END	0x20200000	/* RAM system area end */

/* User definition */
#define RI_USERAREA_TOP	0x20100000	/* RAM user area top */
