...
/*
 *	utk_config_depend.h (h83069)
 *	System Configuration Definition
 */

/* ROMINFO */
#define SYSTEMAREA_TOP	0x00ffc100	/* RAM system area top */
#define SYSTEMAREA_END	0x00fffe60	/* RAM system area end */

/* User definition */
#define RI_USERAREA_TOP	0x00ffff20	/* RAM user area top */
#define RI_USERINIT	NULL	/* User initialization program */

/* Stacks */
#define RI_INTSTACK	0x00ffff20 /* Interrupt stack top(internal RAM end) */
...
#define CFN_REALMEMEND		((VP)0x00ffff20)
