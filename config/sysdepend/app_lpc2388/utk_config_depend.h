...
#define SYSTEMAREA_END	0x4000e800	/* RAM system area end */

/* User definition */
#define RI_USERAREA_TOP	0x40010000	/* RAM user area top */
...
#define CFN_REALMEMEND		((VP)0x40010000)
...
#define EXCEPTION_STACK_TOP     0x40010000
